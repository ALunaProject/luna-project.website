...
const User = {
    ...
    comments: [
        {
            id: '1',
            content: 'Looking started he up perhaps against. How remainder all additions get elsewhere resources. One missed shy wishes supply design answer formed. Prevent on present hastily passage an subject in be. Be happiness arranging so newspaper defective affection ye.'
        },
        {
            id: '2',
            content: 'Looking started he up perhaps against. How remainder all additions get elsewhere resources. One missed shy wishes supply design answer formed. Prevent on present hastily passage an subject in be. Be happiness arranging so newspaper defective affection ye.;'
            ...
            <section className={s.content}
                ...
                <div className={s.userInfo}>
                    ...
                    <aside className={s.userFavGames}>
                        ...
                        <div className={s.favGamesWrapper}>
                            <GamesCard name="Red Dead Redemption II"
                                       ...
                                       tags={['Western', 'Violent', 'Simulator', 'Horror']}
                            />
                            <GamesCard name="Clair Obscur: Expedition 33"
                                       imageUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFe_GrvFbrvky2v1tK5xa-IkuQ46vRvH-Y0lwVuNt5lWiYKvRm84Yiz4Q&s=10"
                                       tags={['Western', 'Violent', 'Simulator', 'Horror']}
                            />
                            <GamesCard name="Red Dead Redemption II"
                ...
                <div className={s.userCommentsWrapper}>
                    ...
                    {User.comments.map(comment => (
                        <Comments key={comment.id} user={User.username} userPP={User.profilePicUrl}
